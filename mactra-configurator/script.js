		...
		let led_picker_active = [0,0];
		let color_updated = [false, false];
		...
		function setBrightnessValue(val) {
			const percent = Math.round((val / 31) * 100);
        ...
        document.getElementById('led-brightness').addEventListener('input', (e) => {
            // Convert 0-31 scale to 0-100% for the user
